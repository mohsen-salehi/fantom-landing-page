...
function Ecosystem() {
    return (
        <section className="w-full flex my-20 p-2 flex-wrap">
            <div className="w-1/2 text-white flex content-center p-5 flex-wrap">
                ...
                <p>
                    Developers, traders, and liquidity providers <br/>  participate together in a financial marketplace <br/> that is open and accessible to all.
                </p>
            </div>
            <div className="w-1/2 flex items-center justify-center p-5">

                <div className="w-[648px] bg-[url('/background-1.svg')]  h-[319px]">
