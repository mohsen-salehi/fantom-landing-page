    ...
    return (
        <section className="w-full my-20 text-white flex p-2 flex-wrap">
            ...
            <div className="w-full flex justify-between flex-wrap p-5 mt-2 lg:gap-0 gap-[20px]">
                <div
                    className="lg:w-[55%] w-full bg-current gradient-border lg:h-[400px] h-auto">
                    <div className="w-full p-8 h-full bg-stone-800 bg-opacity-25 backdrop-blur-[1px]">
                        <div className="w-full p-2 flex flex-wrap">
                            <h3 className='text-white text-3xl'>
                                What can we expect in the future?
                            </h3>
                            <p className="w-full my-5 text-gray-400 font-inter text-base font-normal leading-[157.33%]">
                ...
                <div className="lg:w-[44%] w-full flex flex-wrap content-between items-center lg:gap-0 gap-[20px]">
                    <div className="border p-3 py-5 w-full flex flex-wrap">
                        <h3 className="text-white font-inter text-xl font-medium leading-[133.125%] capitalize me-1">FTM
                            Wallet</h3>
                        <Image
                            ...
                            height={18}
                        />
                        <div className="w-full text-gray-400 font-inter text-base font-normal leading-[157.33%] mt-2">
                            Having a unique FTM wallet for Android and iOS is crucial in the Fantom Sonic Network
                            ecosystem.
                        </div>
                    </div>
                    <div className="border p-3 py-5 w-full flex flex-wrap">
                        <h3 className="text-white font-inter text-xl font-medium leading-[133.125%] capitalize me-1">Launchpad</h3>
                        <Image
                            src="/arrow-right-up.svg"
                            alt="arrow"
                            className="mx-2"
                        ...
                        />
                        <div className="w-full text-gray-400 font-inter text-base font-normal leading-[157.33%] mt-2">
                            The Launchpad feature holds immense potential to enhance liquidity on FTMSwap and attract a
                            wider user base in the future.
                        </div>
                    </div>
                    <div className="border p-3 py-5 w-full flex flex-wrap">
                        <h3 className="text-white font-inter text-xl font-medium leading-[133.125%] capitalize me-1">Airdrop</h3>
                        <Image
                            src="/arrow-right-up.svg"
                            alt="arrow"
                            className="mx-2"
                        ...
                        />
                        <div className="w-full text-gray-400 font-inter text-base font-normal leading-[157.33%] mt-2">
                            We are diligently preparing for an upcoming airdrop exclusive to the FTM Swap community in
                            the near future.
                        </div>
                    </div>
                </div>
